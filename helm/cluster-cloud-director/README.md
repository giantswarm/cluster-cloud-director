...
| `controlPlane.dns.imageRepository` | **Repository**|**Type:** `string`<br/>**Example:** `"giantswarm"`<br/>**Default:** `"giantswarm"`|
| `controlPlane.dns.imageTag` | **Tag**|**Type:** `string`<br/>**Example:** `"v1.9.3"`<br/>**Default:** `"v1.9.3"`|
...
| `controlPlane.image.repository` | **Repository**|**Type:** `string`<br/>**Example:** `"giantswarm"`<br/>**Default:** `"giantswarm"`|
...
| `providerSpecific.vmBootstrapFormat` | **Ignition or cloud-init for OS initialization** - Select either 'ignition' for Flatcar or 'cloud-init' for other OSes (e.g. Ubuntu).|**Type:** `string`<br/>**Default:** `"cloud-init"`|
